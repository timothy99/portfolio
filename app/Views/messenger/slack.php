					...
					<div class="col-12">
						<div class="card card-info">
							<div class="card-header">
								<h3 class="card-title">슬랙 보내기</h3>
							</div><!-- /.card-header -->

							<div class="card-body">
								<div class="form-group row">
									<label for="slack_url" class="col-sm-2 col-form-label">슬랙 URL</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="slack_url" name="slack_url">
									</div>
								</div>
								<div class="form-group row">
